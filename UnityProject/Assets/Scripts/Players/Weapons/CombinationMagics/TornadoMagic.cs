...
namespace CombinationMagician.Players.Weapons.CombinationMagics
{
    ...
    /// 竜巻の合体魔法のクラス
    /// </summary>
    public class TornadoMagic : MonoBehaviour, ICombinationMagic
    {
        ...
        [SerializeField, Header("x軸方向に与える力")]
        float _force;
        ...
        void Start()
        {
            ...
            _limitX =
                UnityEngine.Camera.main.ViewportToWorldPoint(Vector3.zero).x
                - _spriteRenderer.bounds.size.x;
        }
        ...
        void OnTriggerEnter2D(Collider2D collision)
        {
            ...
            if (obj.CompareTag(_enemyTag))
            {
                ...
                enemy.TakeDamage(_damage, MagicAttribute.Fire | MagicAttribute.Water);
